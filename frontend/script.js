    ...
    const medicalGroups = [
        {
            ...
            followUps: [
                "Revmakardit", "Miokard infarktı", "Oynaqların kəskin revmatizmi", "Böyrək xəstəlikləri", "Stenokardiya", "Ürək çatışmazlığı", "Digər"
            ],
            allowCustom: true
        },
        {
        ...
        },
        {
            ...
            followUps: ["Frontal Sinusit", "Maksillar Sinusit", "Tonzil Hipertrofiyası", "Digər"],
            allowCustom: true
        },
        {
        ...
        },
        {
            ...
            followUps: ["Epilepsiya", "Nevralgiyalar", "Paraliç", "Psixiatrik müalicə", "Digər"],
            allowCustom: true
        },
        {
            title: "Qaraciyər xəstəlikləri",
            triggerName: "liver_diseases",
            followUps: ["Hepatit A", "Hepatit B", "Hepatit C", "Qaraciyər çatışmazlığı", "Digər"],
            allowCustom: true
        },
        {
        ...
        },
        {
            ...
            followUps: ["Revmatoid artrit", "Böyrək transplantasiyası", "Radioterapiya", "Sifilis", "Böyrək çatışmazlığı", "QİÇS", "Kimya terapiya", "Hemodializ", "Adrenalin çatışmazlığı", "Digər"],
            allowCustom: true
        },
        {
            title: "Vərdişlər",
